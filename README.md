# pingd - Simple but powerful push notification service
...
Full guides, API reference, and the FAQ live at [docs.pingd.dev](https://docs.pingd.dev).
...
pingd is built using excellent open-source Swift projects:

- [Vapor](https://github.com/vapor/vapor)
- [Fluent](https://github.com/vapor/fluent)
- [Fluent SQLite Driver](https://github.com/vapor/fluent-sqlite-driver)
- [SwiftNIO](https://github.com/apple/swift-nio)
- [APNSwift](https://github.com/vapor/apns)
- [swift-webpush](https://github.com/mochidev/swift-webpush)
